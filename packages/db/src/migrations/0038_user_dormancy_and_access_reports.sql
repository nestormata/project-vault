...
CREATE UNIQUE INDEX "idx_security_alerts_dormant_user" ON "security_alerts" USING btree (("payload"->>'userId')) WHERE "security_alerts"."alert_type" = 'user.dormant' AND "security_alerts"."status" != 'dismissed';
