...
import { LoginRequestSchema } from '@project-vault/shared'
import { mfaVerifyLoginBodySchema } from './schema.js'
...
export const cliMfaVerifyLoginBodySchema = mfaVerifyLoginBodySchema
