...
// Story 29.4 AC8 — `allowedDataPaths` (Story 25.12's retired DATA-relay path allowlist) is
// removed from this type: `apps/api`'s `ExtensionPanelOkSchema` no longer serves it (the DATA
// relay it gated has been deleted outright, replaced by directly-mounted module-data routes).
