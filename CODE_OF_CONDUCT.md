...
For this project, community spaces include this repository's issues, pull requests, discussions,
...
**Reporting channel.** Open a GitHub issue titled "Code of Conduct report" that contains no
details of the incident, and a maintainer will follow up privately. If the report involves a
